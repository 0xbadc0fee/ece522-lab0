...
proc create_root_design { parentCell } {
  ...
  set GPIO_Ins [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 GPIO_Ins ]

  set GPIO_Outs [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 GPIO_Outs ]

  set PNL_BRAM [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:bram_rtl:1.0 PNL_BRAM ]
  ...
  connect_bd_intf_net -intf_net PNL_BRAM_1 [get_bd_intf_ports PNL_BRAM] [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports GPIO_Ins] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports GPIO_Outs] [get_bd_intf_pins axi_gpio_0/GPIO2]
